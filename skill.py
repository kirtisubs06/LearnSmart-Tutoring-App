...
class EnglishSkill(Enum):
    ...
    VOCABULARY = ("Vocabulary",
                  ...
                  prompts.ENGLISH_VOCABULARY_QUESTION_GENERATION_PROMPT,
                  prompts.ENGLISH_VOCABULARY_ANSWER_EVALUATION_PROMPT, "Word")
    GRAMMAR = ("Grammar",
               "Enhancing grammatical knowledge and correcting sentence errors.",
               prompts.ENGLISH_GRAMMAR_QUESTION_GENERATION_PROMPT,
               prompts.ENGLISH_GRAMMAR_ANSWER_EVALUATION_PROMPT, "Sentence")
    READING = ("Reading Comprehension",
               ...
               prompts.ENGLISH_READING_ANSWER_EVALUATION_PROMPT, "Passage")
    WRITING = ("Writing",
               ...
               prompts.ENGLISH_WRITING_ANSWER_EVALUATION_PROMPT, "Prompt")

    def __init__(self, value, description, question_generation_prompt, answer_evaluation_prompt, label):
        self._value_ = value
...
class MathSkill(Enum):
    ...
    ARITHMETIC = ("Arithmetic",
                  ...
                  prompts.MATH_ANSWER_EVALUATION_PROMPT, "Problem")
